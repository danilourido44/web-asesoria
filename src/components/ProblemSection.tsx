      ...
      <div className="mx-auto max-w-6xl">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 font-display text-3xl font-bold leading-tight text-navy md:text-4xl">
            <StaggerText text="El agujero negro documental" />
          </h2>
        ...
        <ul className="mx-auto mt-10 grid max-w-4xl gap-3 sm:grid-cols-2">
          {PAIN_POINTS.map((point, i) => (
            <Reveal
              ...
              className="spotlight flex items-start gap-3 rounded-xl bg-cream px-4 py-3.5 shadow-sm transition-shadow hover:shadow-md"
            >
